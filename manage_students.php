        ...
        buttons: [
            'copy', 'csv', 'excel', 'pdf', 'print'
					...
					<div class="col-md-4 charts-grids widget states-mdl" style="width:100%">
						...
						<h4 class="title">DRUGS AVAILABLE</h4>
                      ...
                      while($found = mysqli_fetch_array($retrieved))
	                     {
			                 ...
			                 <td>
                                <a data-toggle='modal' data-bn='$fname' data-br='$dop' data-bl='$doe' data-bc='$Quantity' data-dp='$retail' data-tf='$email' data-id='$ids' data-im='$fullnames' data-em='$location' data-ep='$phone' data-et='$email' data-pm='$pp' href='#Code1' class='open-Code1 btn  btn-info' title='Edit student records'><span class='glyphicon glyphicon-edit' style='color:white;'></span></a>
